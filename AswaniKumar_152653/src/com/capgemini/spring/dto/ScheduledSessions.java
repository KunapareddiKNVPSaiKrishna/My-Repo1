...
public class ScheduledSessions {
	...
	public ScheduledSessions(int id, String sessionsName, int duration, String faculty, String mode) {
		super();
		this.id = id;
	...
	public String toString() {
		return "ScheduledSessions [id=" + id + ", sessionsName=" + sessionsName + ", duration=" + duration
				+ ", faculty=" + faculty + ", mode=" + mode + "]";
	}
